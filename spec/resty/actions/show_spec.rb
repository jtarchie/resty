  ...
  context "with an instance of the action" do
    ...
    context "with a valid request object" do
      ...
      context "when the resource exists" do
        ...
        before { ExampleApp::PostsController.any_instance.stub(:show).with({"id" => "1"}).and_return(resource) }
      ...
      context "when the resource does not exist" do
        before { ExampleApp::PostsController.any_instance.stub(:show).with("id" => "1").and_return(nil) }
    ...
    context "with an invalid request object" do
      context "because the path is missing a resource id" do
        ...
        before { ExampleApp::PostsController.any_instance.stub(:show).with("id" => nil).and_return(nil) }
